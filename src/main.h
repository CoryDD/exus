...
#define START_MASTERNODE_PAYMENTS_TESTNET 1518161400 // Friday, 2018 February 9 07:30:00 UTC
#define START_MASTERNODE_PAYMENTS 1518161400         // Friday, 2018 February 9 07:30:00 UTC

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (5000.0*COIN);

static const int64_t STATIC_POS_REWARD = 0 * COIN; // Static reward is 0
static const int64_t TARGET_SPACING = 1 * 60;
static const int64_t STAKE_TIMESPAN_SWITCH_TIME = 1518161400;

/**
 Block reward every 60 seconds
*/
inline int GetTargetSpacing(int Height=nBestHeight, bool fProofOfStake=false) { return TARGET_SPACING; }
...
static const int64_t MAX_MONEY = 41805578 * COIN; // 21102789 POW
...
inline int64_t GetMNCollateral(int nHeight) { return 5000; } // Masternode requirement
...
public:
    ...
    {
        // exus: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // exus: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // exus: two types of block: proof-of-work or proof-of-stake
    ...
    // exus: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // exus: trust score of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
    int64_t nMoneySupply;
#endif
    unsigned int nFlags;  // exus: block index flags
    enum
    {

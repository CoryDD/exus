...
{
    resize(900, 520);
    setWindowTitle(tr("Exus") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/exus-48"));
    setWindowIcon(QIcon(":icons/exus-48"));
#else
    ...
    // Title bar styling
    setObjectName("exus");
    setStyleSheet("#exus { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #cecece, stop: 1 #e4e4e4);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    // Light Bottom Status Bar:
    statusBar()->setStyleSheet("#statusBar { color: #2a2a2a; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #e4e4e4, stop: 1 #cecece);  }");
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/button_dashboard"), tr("&Dashboard"), this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Exus address"));
    ...
    addressBookAction = new QAction(QIcon(":/icons/button_addresses"), tr("&Addresses"), this);
    addressBookAction->setToolTip(tr("Edit the list of stored addresses and labels"));
    addressBookAction->setCheckable(true);
    addressBookAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(addressBookAction);

    masternodeManagerAction = new QAction(QIcon(":/icons/button_masternodes"), tr("&Masternodes"), this);
    masternodeManagerAction->setToolTip(tr("Show Master Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    messageAction = new QAction(QIcon(":/icons/button_messages"), tr("&Messages"), this);
    messageAction->setToolTip(tr("View and Send Encrypted messages"));
    messageAction->setCheckable(true);
    tabGroup->addAction(messageAction);

    blockAction = new QAction(QIcon(":/icons/button_explorer"), tr("&Block Explorer"), this);
    ...
    aboutAction = new QAction(tr("&About Exus"), this);
    aboutAction->setToolTip(tr("Show information about Exus"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Exus"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/exus-48"), tr("&Show / Hide"), this);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #f2f2f2; font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-weight: 100; font-variant: small-caps; padding: 3px; border: none;}"
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/exus_testnet"));
            setWindowIcon(QIcon(":icons/exus_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/exus_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Exus client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Exus client"));
    trayIcon->setIcon(QIcon(":/icons/exus-48"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Exus network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setText(tr(clientModel->isImporting() ? "Importing blocks..." : "Synchronizing with EXUS network..."));
        progressBarLabel->setVisible(true);
        // progressBarLabel->setStyleSheet("QLabel { color: #efefef; }"); // Light font
        progressBarLabel->setStyleSheet("QLabel { color: #2a2a2a; }"); // Dark font
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Exus address or malformed URI parameters."));
    }

...
private slots:
    ...
    QString BuyEXUS(QString OrderType, double Quantity, double Rate);
    QString SellEXUS(QString OrderType, double Quantity, double Rate);

...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EXUS");
    case mBTC: return QString("mEXUS");
    case uBTC: return QString::fromUtf8("μEXUS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Exuss");
    case mBTC: return QString("Milli-Exuss (1 / 1,000)");
    case uBTC: return QString("Micro-Exuss (1 / 1,000,000)");
    default: return QString("???");
    }
}
